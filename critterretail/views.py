...
def product(request, productID):
	...
	return render(request, 'product.html', {"product": product, "productJSON":product.jsonValue(), "averageRating": avgRating, "ratingCount":len(ratings), "reviews":reviews})